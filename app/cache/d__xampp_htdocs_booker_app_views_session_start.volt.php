...
<html lang="en">
  <head>
    ...
    <title>Login</title>
    <!-- Bootstrap -->
    <link href="../public/css/bootstrap_old/bootstrap.min.css" rel="stylesheet">
    <!--Custom -->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="wrap">
               ...
               <input type="text" name="email" placeholder="Employee email" value="<?php echo $this->request->getPost('email');?>"/>
